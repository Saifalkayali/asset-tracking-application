...
public class ToAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //sending email
        ...
        String subject = ( bean.getTitle()+  " - "+ "Request Escalated");
        String message = ("A new asset request has been escalated to the admin queue");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        } catch (SQLException | AssetDBException ex) {
            Logger.getLogger(ToAdminServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
