 ...
 * @author salkayali
 */
public class SendApprovedServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String subject = ( bean.getTitle()+  " - "+ "Asset Request Complete");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SendApprovedServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
