 ...
 * @author salkayali
 */
public class ToMoreInfoPageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       AssetBean bean = asset1.getRequest(reqid);
        ...
        request.getRequestDispatcher("/reqInfo.jsp").forward(request, response);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ToMoreInfoPageServlet.class.getName()).log(Level.SEVERE, null, ex);
